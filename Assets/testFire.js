...
function Start () {
    ...
    dragPlane = Plane(dragPlaneNormal, renderer.bounds.center);
    ...
    dragZone.transform.position = renderer.bounds.center;   
...
function OnMouseDrag () {
    ...
    if (dragPlane.GetDistanceToPoint(renderer.bounds.center) != 0) {
    ...
    if (dragPlane.Raycast(mouseRay, intersectDist)) {
        ...
        dragDistance = Mathf.Clamp((mousePos3D - renderer.bounds.center).magnitude, 0, magBase);
        ...
        forceVector = mousePos3D - renderer.bounds.center;
        ...
        Debug.DrawRay(renderer.bounds.center, forceVector / magMultiplier, currentColor);
    ...
    //update the position of the dragzone
	//transform.FindChild("Center").transform.position
    dragZone.transform.position = renderer.bounds.center;
